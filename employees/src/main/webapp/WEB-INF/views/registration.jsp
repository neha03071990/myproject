...
<head>
	...
	<title>Employee Registration Form New2.0.</title>
...
<body>
	...
	<form:form method="POST" modelAttribute="employee">
		...
		<table>
			...
			<tr>
				<td><label for="joiningDate">Employee Joining Date: </label> </td>
	...
	<br/>
	<br/>
	Go back to <a href="<c:url value='/list' />">Show me  All Employees</a>
</body>
</html>
